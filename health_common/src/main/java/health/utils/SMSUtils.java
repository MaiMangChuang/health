...
public class SMSUtils {
	public static final String VALIDATE_CODE = "SMS_213691757";//发送短信验证码模板编码  模版CODE
	public static final String ORDER_NOTICE = "SMS_159771588";//体检预约成功通知
	private static final String SIGN_NAEM = "mmc验证码";// 短信的签名
	private static final String PARAMETER_NAME="code";
	private static final String ACCESS_KEY="LTAI5tSKT1YU4j22soT3j3N8"; //你的AccessKey ID
	private static final String SECRET_KEY="k9x2AEgZib6CeW46i94YYoewkAgsM9"; //你的AccessKey Secret
